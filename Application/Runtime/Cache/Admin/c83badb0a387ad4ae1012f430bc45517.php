    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                <div class="form-group">
                    <!--<label class="col-sm-2 control-label">编号：</label><div class="col-sm-4"><input name="bk_code" type="text"  value="<?php echo ($data["bk_code"]); ?>" class="form-control"></div>-->
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label">数量：</label><div class="col-sm-4"><input name="bk_totalnum" type="text" value="<?php echo ($data["bk_totalnum"]); ?>" class="form-control"></div>
                </div>
                <div class="form-group">
...
//                        required: true
                ...
                submitHandler: function(){
                    ...
                    $.post('/bms/index.php/Admin/Book/submitAdd', f.serialize(), function(result){
                        if('0' == result){
                            $("#sys_dlg").modal('hide');
